...
model_trainer._eval_save_prefix = "wcml-yahoo-test-pos"
model_trainer._evaluate_partial(test_dataset_pos)

model_trainer._eval_save_prefix = "wcml-yahoo-test-neg"
...
print(eq("wcml-yahoo-test-pos_evaluate_partial.pickle", "wcml-yahoo-test-neg_evaluate_partial.pickle", "training_arr.npy"))
